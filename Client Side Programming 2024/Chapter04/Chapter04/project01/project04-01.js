...
function calcTotal() {
   ...
   try 
   {
      if (!(wgtBox.value > 0)) throw "!! Enter a positive value for the weight!!";
   ...
   try
   {
      if (!(distBox.value > 0)) throw "!! Enter a positive value for the distance!!";
   ...
   // Display /t/he moving cost estimate in the totalBox, formatted as currency
